...
Defines requirements for verifying a user's email address after registration, including token generation and delivery, the verification endpoint, resend capability, and frontend states for the verification flow.
