...
Defines how the Preview tab sources and navigates records from the active job, and the Generate CTA that submits records to the render queue from within the preview surface.
