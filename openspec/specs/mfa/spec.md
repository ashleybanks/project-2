...
Defines requirements for TOTP-based multi-factor authentication, including enrollment, sign-in challenge, disabling MFA, session state exposure, and the MFA settings UI.
