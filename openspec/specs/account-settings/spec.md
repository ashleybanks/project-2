...
Defines requirements for the account settings page, where authenticated users can view their profile, update their display name, change their password, and see the status of connected authentication methods and MFA.
